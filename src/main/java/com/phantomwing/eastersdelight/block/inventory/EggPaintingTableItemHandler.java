package com.phantomwing.eastersdelight.block.inventory;
...
public class EggPaintingTableItemHandler implements IItemHandler
{
	...
	public EggPaintingTableItemHandler(IItemHandler itemHandler, @Nullable Direction side) {
