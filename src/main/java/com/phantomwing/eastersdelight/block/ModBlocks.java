...
public class ModBlocks {
    ...
    public static final DeferredBlock<Block> EGG_PAINTER = BLOCKS.register("egg_painter",
            () -> new EggPainterBlock(Block.Properties.ofFullCopy(Blocks.CRAFTING_TABLE).forceSolidOn()
                    .pushReaction(PushReaction.DESTROY).noOcclusion()));
    public static final DeferredBlock<Block> DYED_EGG = BLOCKS.register("dyed_egg",
            () -> new DyedEggBlock(Block.Properties.of().noOcclusion().forceSolidOn().strength(0.5F)
